...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx6922d2caa8be2aa1',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '7b190b25b90aa18c35556523d8ad0aff',
  ...
  USERS: [
    {
      ...
      id: 'ovY976FEDD5j7_PQ3Bs5KkKBJcd8,ovY976BuRKFkbTyBQv5LV5610sh4,ovY976NHKJTbLjJ0F6pxetHSZbDw',
      // 你想对他发送的模板消息的模板ID
